...
public class PrestamoController {
	...
	public static void registrar(Prestamo prestamo) {
        LibrosController.marcarComoPrestado(prestamo.getCodigoLibro());
        try {
            ...
            bufferedWriter.write(prestamo.getCodigoLibro() + SEPARADOR_CAMPO + prestamo.getNumeroSocio()
                    + SEPARADOR_CAMPO + prestamo.getFechaFormato() + SEPARADOR_REGISTRO);
    ...
    public static void solicitarDatosYCrearPrestamo() {
        ...
        Socio socio = SocioController.imprimirSociosYPedirSeleccion();
        PrestamoController.registrar(new Prestamo(libro.getCodigo(), socio.getCi(), LocalDateTime.now()));
